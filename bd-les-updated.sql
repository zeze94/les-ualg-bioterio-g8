...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2018 at 08:06 PM
...
(6, '', 'ver banas', 1, 1),
(7, '', 'ver morangos', 2, 2),
(8, '', 'ver morangos con açiasdfda', 1, 2),
(9, '', 'teste de outra função', 1, 2),
(10, '', 'bananas no mesmo', 1, 1),
(11, '', 'bananas no outro projeto', 2, 1);
...
(1, '2018-05-21 00:00:00', 234234, 234234, 1, 1, 234243, 1),
(2, '2018-05-22 00:00:00', 45645, 5457, 1, 1, 98796, 1),
(3, '2018-05-22 00:00:00', 2234, 234, 1, 1, 234, 1),
(4, '2018-05-25 00:00:00', 234, 234, 1, 1, 234, 1);
...
INSERT INTO `tanque` (`idTanque`, `nroAnimais`, `sala`, `observacoes`, `Lote_idLote`, `Circuito_Tanque_idCircuito`) VALUES
(1, 234234, '234223', '4234', 1, 1);
...
--
ALTER TABLE `circuito_tanque`
  MODIFY `idCircuito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `ensaio`
  MODIFY `idEnsaio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `reg_amostragens`
  MODIFY `idRegAmo` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `reg_cond_amb`
--
ALTER TABLE `reg_cond_amb`
  MODIFY `idRegCondAmb` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tanque`
  MODIFY `idTanque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
